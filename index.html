...
<!-- START CSS -->		
	...
	<link href="css/ColaborateFont" rel="stylesheet">
<!-- START Javascript -->	
    <script type="text/javascript" src="js/modernizr.js"></script>
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="js/tremer.js"></script> 		
	<script src="player/video.js"></script>ColaborateFont	
</head>
<body>
<div id="loading_page">
    ...
    <section class="content-area" id="content-area">
        <div class="container">
            <div class="row">
                ...
                <section class="col-md-8 content-section"> <h4 class="section-title"><span>Familia MegaCraftBR</span></h4>
      <div id="pre">O MegaCraftBR &eacute; uma comunidade de servidores de minecraft, dentro de nossos servi&ccedil;os existem o MegaCraftBR Survival, e o MegaCraftBR Skyblock, que tem a finalidade de divert&iacute;-los e distra&iacute;-los    gratuitamente.</div>
      <h4 class="section-title"><span>Plugins e Conteudo do Servidor</span></h4>
<div id="pre">
[<span style="color: #000000;">✔</span>] Plugin LWC como protecao de blocos, Ba&uacute;s, CraftTable, Fornalhas, Portas, ETC.<br/>
[<span style="color: #000000;">✔</span>] Plugin Anti-Palavr&otilde;es, pois ningu&eacute;m &eacute; obrigado a participar da raiva dos outros players.<br/>
[<span style="color: #000000;">✔</span>] Arenas PVP, para vingar daquele man&eacute; que te matou quando estava NOOB. <br/>
[<span style="color: #000000;">✔</span>] Plugins Anti-Hack para melhor qualidade de jogo.</font></div>
      <h4 class="section-title"><span>Destaques da Semana</span></h4>
      <pre><img src="img/todos.png" height="300"></pre>
      <h4 class="section-title"><span>Bloco de Debate</span></h4>
 <pre><video id="Cube Land" class="video-js vjs-default-skin" controls
 preload="auto" width="100%" height="450" poster="player/post-videos/video-minecraft.png"
 data-setup="{}">
 <source src="player/videos/Cube Land.mp4" type='video/mp4'>
</video></pre>
      <h4 class="section-title"><span>Agradecimentos</span></h4>
       <div id="pre">Agradecemos a todos os player que jogam em MegaCraftBR, obrigado pela prefer&ecirc;ncia e continue nos     orgulhando jogando em nossos servidores!</div>
  </section>
